...
var onScreenness = new function () {
  ...
  var roundAt = function roundAt(number, decimals) {
  ...
  var calculatePresence = function calculatePresence(boundingRect) {
    var pixelDistance = {
  ...
  var applyIdentifiers = function applyIdentifiers(element, presence) {
